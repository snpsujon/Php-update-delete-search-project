...
if (mysqli_num_rows($result) > 0) {
	...
	echo "<tr>";
        echo "<td>" . $row["Id"]. "</td><td>" . $row["Name"]. "</td><td>" .$row["Phone"]."</td><td>" . $row["Address"]. "</td><td>"."<a href='delete.php?id=".$row["Id"]."'>Delete</a>"." | "."<a href='up.php?id=".$row["Id"]."'>Update</a>"." | "."<a href='iprint.php?id=".$row["Id"]."'>Print</a>"."</td>";
