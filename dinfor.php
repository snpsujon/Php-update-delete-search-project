...
if (mysqli_num_rows($result) > 0) {
	...
	echo "<tr>";
        echo "<td>" . $row["Id"]. "</td><td>" . $row["Name"]. "</td><td>" .$row["Phone"]."</td><td>" . $row["Type"]. "</td><td>"."<a href='ddelete.php?id=".$row["Id"]."'>Delete</a>"." | "."<a href='dupdatef.php?id=".$row["Id"]."'>Update</a>"."| "."<a href='dprint.php?id=".$row["Id"]."'>Print</a>"."</td>";
